<template>
    <div class="flex-container__Base_A" id="AnBottom">
            <br>
            <div v-for="announce in announcements"  v-bind:key="announce.Special_Announcement_Title">
                <div v-if="announce.Page_on_which_to_show___Home_Page_ === 'Bottom' ">
...
created: function() {
    axios
    .get('https://api.steinhq.com/v1/storages/5d0374a0e8f87532b83a4e3b/SpAnnouncement_Output')
    .then(res => {
